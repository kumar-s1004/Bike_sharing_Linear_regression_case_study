...
- check correlation between the variables with pairplot 
...
- The R-squared value of the train set is 72% whereas the test set has a value of 69.4% which suggests that our model broadly explains the variance quite decently on the test set and thus we can conclude that it is a good model.
...
## Contact
Created by [@kumar-s1004](https://github.com/kumar-s1004) - feel free to contact us!
